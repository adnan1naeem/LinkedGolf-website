...
const StatCard: React.FC<StatCardProps> = ({ count, label, isHighlight }) => {
    return (
        <Box component="div" sx={{ margin: '8px' }}>
            {isHighlight ? (
                <HighlightCard>
                    <Typography fontSize={{xs:"28px",md:"30px",lg:"40px"}} fontFamily={"inter"} sx={{ fontWeight: 'bold',color:'#2A2A2A' }}>
                        {count}
                    </Typography>
                ...
                <RegularCard>
                    <Typography fontSize={{xs:"28px",md:"30px",lg:"40px"}} fontFamily={"inter"} sx={{ fontWeight: '700',color:'#2A2A2A' }}>
                        {count}
                    </Typography>
                    <Typography fontSize={{xs:"20px",md:"30px",lg:"40px"}} fontFamily={"Barlow-Medium"} sx={{color:'#2A2A2A' }} >{label}</Typography>
                </RegularCard>
